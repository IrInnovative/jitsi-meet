...
export default {
    ...
    createInitialLocalTracksAndConnect(roomName, startScreenSharing) {
        ...
        if (startScreenSharing) {
            ...
            tryCreateLocalTracks = createLocalTracks(
                ...
                .catch(err => {
                    // If audio failed too then just return empty array for
                    // tracks.
                    audioOnlyError = err;
                    return [];
                });
        ...
        .then(([tracks, con]) => {
            ...
            if (audioAndVideoError || audioOnlyError) {
                if (audioOnlyError && !audioAndVideoError) {
    ...
    toggleScreenSharing() {
        ...
        if (!this._untoggleScreenSharing) {
            return this._switchToScreenSharing();
        } else {
     ...
     * @private
     */
    _switchToScreenSharing() {
        this.videoSwitchInProgress = true;
        return this._createDesktopTrack().then(stream => {
